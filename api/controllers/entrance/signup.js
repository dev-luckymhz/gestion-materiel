...
the account verification message.)`,
  ...
  exits: {
    ...
    emailFormatInvalid: {
      statusCode: 409,
      description: 'your address is not valid',
    },
  ...
  fn: async function ({emailAddress, password, fullName}) {
    ...
    const emailFormat=/^[a-zA-Z0-9_.+-]+@greentsika\.com+$/;
    if( !newEmailAddress.match(emailFormat)){
      sails.log('email invalid')
      throw "emailFormatInvalid";
    }
